...
def main():
    ...
    print("  origin: original images moved here when processing fails")
...
PowerShell example:
1. 默认:
python ./process/04_image_crop_seg_v3_fail_grouped_with_origin_adaptive_padding.py `
  --input_dir ./images/process_image/test/test_100-3/debug/process_fail/origin `
  --output_dir ./images/process_image/test/test_fail_30-2 `
